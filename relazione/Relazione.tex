...
\begin{document}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \legend{\texttt{seq\_ext\_1},\texttt{seq\_ext\_2}}
            \end{axis}
        \end{tikzpicture}

        \caption{Confronto delle performance di \texttt{seq\_ext\_1} e \texttt{seq\_ext\_2} su 100 passi di simulazione da 1000 a 10000 corpi (Lenovo IdeaPad 5)}
        \label{fig:seq_ext_table_ip5}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \caption{Confronto delle performance di \texttt{seq\_ext\_1} e \texttt{seq\_ext\_2} su 100 passi di simulazione da 1000 a 10000 corpi (MacBook Air M1)}
        \label{fig:seq_ext_table_m1}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \legend{\texttt{seq\_ext\_1},\texttt{omp\_ext\_1} (1), \texttt{omp\_ext\_1} (2), \texttt{omp\_ext\_1} (4), \texttt{omp\_ext\_1} (8), }
            \end{axis}
        \end{tikzpicture}
        ...
        \caption{Confronto delle performance di \texttt{seq\_ext\_1} e \texttt{omp\_ext\_1} su 100 passi di simulazione da 1000 a 10000 corpi. I numeri tra parentesi nella legenda del grafico indicano il numero di thread attivi}
        \label{fig:omp_1_ext_graph}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \legend{\texttt{seq\_ext\_1},\texttt{omp\_ext\_2} (1), \texttt{omp\_ext\_2} (2), \texttt{omp\_ext\_2} (4), \texttt{omp\_ext\_2} (8), }
            \end{axis}
        \end{tikzpicture}
        ...
        \caption{Confronto delle performance di \texttt{seq\_ext\_1} e \texttt{omp\_ext\_2} su 100 passi di simulazione da 1000 a 10000 corpi. I numeri tra parentesi nella legenda del grafico indicano il numero di thread attivi}
        \label{fig:omp_2_ext_graph}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \legend{\texttt{seq\_ext\_1},\texttt{omp\_ext\_3} (1), \texttt{omp\_ext\_3} (2), \texttt{omp\_ext\_3} (4), \texttt{omp\_ext\_3} (8), }
            \end{axis}
        \end{tikzpicture}
        ...
        \caption{Confronto delle performance di \texttt{seq\_ext\_1} e \texttt{omp\_ext\_3} su 100 passi di simulazione da 1000 a 10000 corpi. I numeri tra parentesi nella legenda del grafico indicano il numero di thread attivi}
        \label{fig:omp_3_ext_graph}
    \end{figure}
    \newpage
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \legend{\texttt{seq\_ext\_1},\texttt{omp\_ext\_4} (1), \texttt{omp\_ext\_4} (2), \texttt{omp\_ext\_4} (4), \texttt{omp\_ext\_4} (8), }
            \end{axis}
        \end{tikzpicture}

        \caption{Confronto delle performance di \texttt{seq\_ext\_1} e \texttt{omp\_ext\_4} su 100 passi di simulazione da 1000 a 10000 corpi. I numeri tra parentesi nella legenda del grafico indicano il numero di thread attivi}
        \label{fig:omp_4_ext_graph}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \legend{\texttt{seq\_ext\_1},\texttt{mpi\_ext\_1} (1), \texttt{mpi\_ext\_1} (2), \texttt{mpi\_ext\_1} (4), \texttt{mpi\_ext\_1} (8), }
            \end{axis}
        \end{tikzpicture}
        ...
        \caption{Confronto delle performance di \texttt{seq\_ext\_1} e \texttt{mpi\_ext\_1} su 100 passi di simulazione da 1000 a 10000 corpi. I numeri tra parentesi nella legenda del grafico indicano il numero di thread attivi}
        \label{fig:mpi_ext_graph}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \legend{\texttt{seq\_ext\_1},\texttt{mpi\_ext\_2} (1), \texttt{mpi\_ext\_2} (2), \texttt{mpi\_ext\_2} (4), \texttt{mpi\_ext\_2} (8), }
            \end{axis}
        \end{tikzpicture}
        ...
        \caption{Confronto delle performance di \texttt{seq\_ext\_1} e \texttt{mpi\_ext\_2} su 100 passi di simulazione da 1000 a 10000 corpi. I numeri tra parentesi nella legenda del grafico indicano il numero di thread attivi}
        \label{fig:mpi_2_ext_graph}
    \end{figure}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \legend{\texttt{seq\_ext\_1},\texttt{mpi\_ext\_3} (1), \texttt{mpi\_ext\_3} (2), \texttt{mpi\_ext\_3} (4), \texttt{mpi\_ext\_3} (8), }
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{figure}[H]
        ...
        \begin{tikzpicture}
            ...
            \legend{\texttt{seq\_ext\_1},\texttt{seq\_bh\_1} }
            \end{axis}
        \end{tikzpicture}
